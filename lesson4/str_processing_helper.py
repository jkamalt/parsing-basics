...
def clean_nb_spaces(input_str):
    """
    Очищает строку от символа неразрывного пробела
    :param input_str: входная строка для пробразования
    :return: строка, очищенная от символов неразрывного проьела
    """
    return input_str.replace(u'\u00A0', ' ')
